...
class DFCC_Home_Settings extends DFCC_Module {
	...
	public function defaults() {
		return array(
			...
			'hero_title'           => __( 'Luxury Boarding & Five-Star Care for Your Best Friend', 'dog-father-control-center' ),
			'hero_subtitle'        => __( 'Private suites, 24/7 veterinary supervision, and a team that treats your dog like family.', 'dog-father-control-center' ),
			'hero_primary_label'   => __( 'Book a Stay', 'dog-father-control-center' ),
			'hero_primary_url'     => '/book-now/',
			'hero_secondary_label' => __( 'Explore Services', 'dog-father-control-center' ),
			'hero_secondary_url'   => '/services/',
			'about_eyebrow'        => __( 'About The Dog Father', 'dog-father-control-center' ),
			'about_title'          => __( 'A Five-Star Home Away From Home', 'dog-father-control-center' ),
			'about_text'           => __( 'At The Dog Father Hotel we blend luxury hospitality with expert canine care. Every guest enjoys a private suite, daily enrichment, gourmet meals, and round-the-clock veterinary supervision — so you can travel knowing your best friend is in the safest, most loving hands.', 'dog-father-control-center' ),
			'services_eyebrow'     => __( 'What We Offer', 'dog-father-control-center' ),
			'services_title'       => __( 'Premium Services', 'dog-father-control-center' ),
			'stat1_number'         => '5,000+',
			'stat1_label'          => __( 'Happy Guests', 'dog-father-control-center' ),
			'stat2_number'         => '24/7',
			'stat2_label'          => __( 'Veterinary Care', 'dog-father-control-center' ),
			'stat3_number'         => '15+',
			'stat3_label'          => __( 'Years of Excellence', 'dog-father-control-center' ),
			'stat4_number'         => '4.9★',
			'stat4_label'          => __( 'Average Rating', 'dog-father-control-center' ),
			...
			'cta_title'            => __( 'Ready to Give Your Dog the Five-Star Treatment?', 'dog-father-control-center' ),
			'cta_text'             => __( 'Reserve a luxury suite today and discover why dog parents trust The Dog Father Hotel.', 'dog-father-control-center' ),
			'cta_button_label'     => __( 'Book Now', 'dog-father-control-center' ),
			'cta_button_url'       => '/book-now/',
			'contact_title'        => __( 'Visit Us', 'dog-father-control-center' ),
		);
	}
