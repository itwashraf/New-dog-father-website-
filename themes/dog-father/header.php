...
<header class="df-header" id="df-header">
	<div class="df-header__inner">
		...
		<nav class="df-nav" id="df-nav" aria-label="<?php esc_attr_e( 'Primary', 'dog-father' ); ?>">
			...
			?>
			<div class="df-nav__cta">
				<a class="df-btn df-btn--primary" href="<?php echo esc_url( $df_book_url ); ?>"><?php echo esc_html( dfather_home( 'header_book_label', __( 'Book Now', 'dog-father' ) ) ); ?></a>
			</div>
		</nav>

		<?php if ( $df_phone || $df_whatsapp ) : ?>
